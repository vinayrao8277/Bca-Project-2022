...
<?php
            ...
            mysqli_query($connect, "UPDATE user SET status = 1 WHERE u_id = '$email'");
            ?>
<script>
alert("Verfiy otp is done... You May Change Password Now...");
window.location.replace("user_newpass.php");
</script>
<?php
        }
