...
<?php 
    ...
    if(isset($_POST["verify"])){
        ...
        $u_addr = $_SESSION['address'];
        $a_no = $_SESSION['aadhar'];
        ...
        if($otp != $otp_code){
            ...
            $result = mysqli_query($connect, "INSERT INTO `user`(`u_name`, `email`, `u_pass`, `a_no`, `u_addr`, `gender`, `mobile`, `status`) VALUES ('$u_name','$email','$u_pass','$a_no','$u_addr','$gender','$mobile',1)");
            ?>
            <script>
            alert("Your Account Verification Successfully... You May Login In Now...");
