...
if(isset($_POST['s']))
{
  ...
  if($_SERVER["REQUEST_METHOD"]=="POST")
  {
    ...
    $fileextstored = array('png', 'jpg', 'jpeg');
     ...
     if(in_array($filecheck,$fileextstored) || !in_array($filecheck,$fileextstored))
      {
      ...
      $comp="INSERT INTO `complaint`(`u_name`, `mobile`, `crime_type`, `d_o_c`,`p_name`, `description`, `image`) VALUES('$u_name','$mobile','$crime_type','$d_o_c','$p_name','$description','$destinationfile')";
      mysqli_select_db($conn,"missing_portal"); 
...
<nav>
     ...
     <form action="#" method="POST" enctype="multipart/form-data" onsubmit="return myfun();">
        <div class="box">
            ...
            <p>
            <h2 style="text-align: center;">Log New Complaint</h2>
            </p><br>
            <hr>
            ...
            <input type="text" placeholder="Enter the crime type" name="type" id="crime" style="text-transform: capitalize;" required>
            <span id="message" style="color:red"></span><br>

            <label><b>Date of Crime</b></label>
            ...
            <button type="submit" class="submitbtn" name="s" id="submit">Submit</button>
        </div>
    </form>
    <style>
    body {
