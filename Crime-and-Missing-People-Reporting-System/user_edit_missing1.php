...
<body>
    <div class="dropdwn">
        <nav>
            ...
            <ul>
                <li><a href="user_views_missing.php">back</a></li>
            </ul>
        </nav>
    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="m_id" disabled value="<?=$result['m_id'];?>" class="form-control">
                            </div>
                            <div class="mb-3">
                            ...
                            <div>
                                ...
                                <!-- <input type="text" name="p_name" value="<?=$result['p_name'];?>" class="form-control"> -->
                            </div>
                            <div class="mb-3">
...
if(isset($_POST['update_complaint']))
{
    ...
    $query = "UPDATE missing SET crime_type='$crime_type', date='$date', p_name='$p_name', description='$description' WHERE m_id='$m_id' ";
    $query_run = mysqli_query($con, $query);
